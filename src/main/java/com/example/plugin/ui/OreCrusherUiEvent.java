...
public class OreCrusherUiEvent {
    public static final BuilderCodec<OreCrusherUiEvent> CODEC =
            BuilderCodec.<OreCrusherUiEvent>builder(OreCrusherUiEvent.class, OreCrusherUiEvent::new)
